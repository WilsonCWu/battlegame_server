...
urlpatterns = [
    ...
    path('event/grass/newrun/', grass_event.NewGrassRunView.as_view()),
    path('event/grass/get/', grass_event.GetGrassEventView.as_view()),
    path('event/grass/collect/', grass_event.CollectDynamiteView.as_view()),
    ...
    path('storymode/finish/', story_mode.StoryFinishView.as_view()),
    ...
    path('pet/update/', pets.UpdatePetView.as_view()),
    path('pet/unlock/master/', pets.UnlockPetView.as_view()),
    path('pet/unlock/starter/', pets.UnlockStarterPetView.as_view()),
