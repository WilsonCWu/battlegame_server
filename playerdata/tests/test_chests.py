...
class ChestAPITestCase(APITestCase):
    ...
    def setUp(self):
        ...
        BaseItem.objects.create(name="Bow1", rarity=1, gear_slot='W', item_type=constants.COIN_SHOP_ITEMS[0], cost=100)
        BaseItem.objects.create(name="Bow2", rarity=2, gear_slot='W', item_type=constants.COIN_SHOP_ITEMS[1], cost=100)
